...
if(isset($_POST['submit'])){
  ...
  elseif($password==$confirmPassword){
    $insertQuery = "INSERT INTO signup (names,email, password, confirm_password, created_at) VALUES ('$names','$email', '$password', '$confirmPassword', NOW())";
      ...
      <div class="login">
        ...
        <form action="" method="POST">
          <div class="main">
            <div class="input">
            <div class="inputbox">
                <input class="" name="names" id="input" type="text" required="required" />
                <span>Names</span>
              </div>
              <div class="inputbox">
                <input class="" name="email" id="input" type="email" required="required" />
                <span>Email</span>
              </div>
              <div class="inputbox">
                <input id="input" name="password" type="password" required="required" />
                <span>Password</span>
              </div>
              <div class="inputbox">
                <input id="input" name="conf_password" type="password" required="required" />
                <span>Confirm Password</span>
              </div>
              <div class="forget">
                <span>Already Have An Account?<span><a href="login.php">Login</a></span></span
                >
              </div>
              <button class="btn in" type="submit" name="submit">Sign Up</button>
            </div>
          </div>
        </form>
      </div>
